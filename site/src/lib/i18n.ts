...
export const UI: Record<Lang, UIStrings> = {
  ...
  en: {
    ...
    trust_pickup: "Hotel pickup included",
    trust_pickup_sub: "Anywhere in Essaouira and Diabat.",
    ...
    prices_note:
      "Prices are per person and include guide, equipment and hotel pickup in Essaouira. Message us for group and family rates.",
    book_this: "Book this",
  ...
  fr: {
    ...
    trust_pickup_sub: "Partout à Essaouira et à Diabat.",
    ...
    prices_note:
      "Tarifs par personne, guide, équipement et transfert depuis votre hôtel à Essaouira inclus. Écrivez-nous pour les tarifs groupes et familles.",
    book_this: "Réserver",
  ...
  es: {
    ...
    trust_pickup: "Recogida en el hotel incluida",
    trust_pickup_sub: "En toda Essaouira y Diabat.",
    ...
    prices_note:
      "Precios por persona, con guía, equipo y recogida en tu hotel de Essaouira incluidos. Escríbenos para tarifas de grupo y familia.",
    book_this: "Reservar",
  ...
  de: {
    ...
    trust_pickup: "Hotelabholung inklusive",
    trust_pickup_sub: "Überall in Essaouira und Diabat.",
    ...
    prices_note:
      "Preise pro Person, inklusive Guide, Ausrüstung und Abholung von deinem Hotel in Essaouira. Für Gruppen- und Familienpreise schreib uns.",
    book_this: "Buchen",
  ...
  ar: {
    ...
    trust_pickup: "التوصيل من الفندق مشمول",
    trust_pickup_sub: "في كل الصويرة وديابات.",
    ...
    prices_note:
      "الأسعار للشخص الواحد وتشمل المرشد والمعدات والتوصيل من فندقك في الصويرة. راسلنا لأسعار المجموعات والعائلات.",
    book_this: "احجز",
