...
export const UI: Record<Lang, UIStrings> = {
  ...
  en: {
    ...
    trust_reply: "We reply within 15 minutes, 10am–8pm",
  ...
  fr: {
    ...
    trust_reply: "Nous répondons en 15 minutes, de 10h à 20h",
  ...
  es: {
    ...
    trust_reply: "Respondemos en 15 minutos, de 10:00 a 20:00",
  ...
  de: {
    ...
    trust_reply: "Wir antworten in 15 Minuten, 10–20 Uhr",
  ...
  ar: {
    ...
    trust_reply: "نردّ خلال 15 دقيقة، من 10 صباحاً إلى 8 مساءً",
